...
//array_push($menu,array('Pedidos (velho)','Relação de pedidos','pedido_todos.php')); 
//array_push($menu,array('Pedidos (velho)','Pedido / Representante','pedido_todos.php')); 
//array_push($menu,array('Orçamento','Orçamento','orcamento.php')); 
//array_push($menu,array('Orçamento (velho)','Orçamento (todos)','orcamento_todos.php')); 
