...
require("cp/cp_vp_transferencia.php");
...
if (strlen($dd[1]) == 0)
	{ $dd[1] = date("d/m/Y"); }
$dd[7] = $user_id;
$dd[10] = 'Transferencia de mercadoria de vendedor para Estoque';
$dd[11] = '';
$dd[12] = 'M';
echo '<FONT class="lt5">'.$dd[10].'</FONT>';
$http_redirect = "vp_transferencia.php?dd1=".$dd[1].'&dd2='.$dd[2];
...
if ($dd[13]=='1')
	...
	$sql .= $user_id.",'','C',";
	$sql .= "'Transferencia de mercadoria para estoque','','".$dd[12]."'); ";
