...
array_push($cp,array('$A6','cr_doc','Lançar como crédito',False,True,''));
array_push($cp,array('$N8','cr_valor','Valor',True,True,''));
array_push($cp,array('$D8','cr_venc','Recebido em',True,True,''));
...
$dd[10] = 1;
$dd[13] = $dd[16];
if (strlen($dd[17]) == 0) { $dd[17] = date("d/m/Y"); }
if (strlen($dd[18]) == 0) { $dd[18] = $dd7.' (crédito)'; }
