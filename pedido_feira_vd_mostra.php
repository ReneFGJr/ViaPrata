<? ob_start(); ?>
<title>Via Prata - Pedido Feira</title>
<?
global $nocab;
$tabela = "pedido_feira";
...
$sql = "select * from pedido_feira ";
$sql .= "left join feira on feira_codigo = p_local ";
$sql .= "where p_pedido = '".strzero($dd[0],7)."'";
$rlt = db_query($sql);
if ($line = db_read($rlt))
	{
...
$item=array();
$sql = "select * from pedido_feira_item ";
$sql .= "inner join produto on pi_codigo = p_codigo ";
$sql .= "where pi_pedido = '".strzero($dd[0],7)."' ";
