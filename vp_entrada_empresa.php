...
if (strlen($dd[1]) == 0)
	{ $dd[1] = date("d/m/Y"); }
$dd[7] = $user_id;
$dd[10] = 'Entrada de mercadoria empresa';
$dd[11] = '';
$dd[12] = 'E';
echo '<FONT class="lt5">'.$dd[10].'</FONT>';
$http_redirect = "vp_entrada_empresa.php?dd1=".$dd[1];
...
$sql = "select * from vp_pedido where vpped_fornecedor='EMPR' order by id_vpped desc limit 20";
$rlt = db_query($sql);
