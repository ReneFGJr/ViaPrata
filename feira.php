...
$menu = array();
/////////////////////////////////////////////////// MANAGERS
array_push($menu,array('Feira','Cidade','cidade.php')); 
array_push($menu,array('Feira','Feiras','feiras.php')); 
array_push($menu,array('Feira','Feiras edições','feiras_edicoes.php')); 
