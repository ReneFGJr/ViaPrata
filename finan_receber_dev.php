...
array_push($cp,array('$S4','cr_cliente','Cliente',False,False,''));
...
array_push($cp,array('$O B:Quitado&A:Aberto','cr_status','Status',False,True,''));
array_push($cp,array('$H1','cr_img','Img',False,True,''));

array_push($cp,array('$N10','cr_valor','valor',False,False,''));
array_push($cp,array('$D8','cr_venc','vencimento',False,False,''));
array_push($cp,array('$S80','cr_historico','histórico',True,True,''));
array_push($cp,array('$S10','cr_pedido','pedido',False,False,''));
array_push($cp,array('$S10','cr_parcela','parcela',False,False,''));
...
<TR valign="top"><TD><form method="post" action="finan_receber_dev.php">
<TABLE class="lt1">
<?
	for ($k=0;$k<99;$k++)
		{
