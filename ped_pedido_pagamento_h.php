...
array_push($cp,array('$S3','cr_banco','Banco',True,True,''));
array_push($cp,array('$S6','cr_doc','Cheque',True,True,''));
...
$dd[10] = 1;
$dd[13] = $dd[16];
if (strlen($dd[18]) == 0) { $dd[18] = $dd7; }
else { 
if (strpos($dd[18],'(BCO') > 0)
	{ $dd[18] = substr($dd[18],0,strpos($dd[18],'(BCO')-1); }
	$dd[18] .= ' (BCO='.$dd[14].'/CHQ '.$dd[15].')'; 
}
//vendedor
//cliente
$saved = editar();
